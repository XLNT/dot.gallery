...
input AssetCreateInput {
  ...
  works: WorkCreateManyWithoutAssetsInput
}
...
input AssetCreateManyWithoutWorksInput {
...
input AssetCreateWithoutWorksInput {
  id: ID
  isCounterfactual: Boolean
  owner: EntityCreateOneWithoutOwnedAssetsInput!
  issue: IssueCreateOneWithoutAssetsInput!
...
input AssetUpdateInput {
  ...
  works: WorkUpdateManyWithoutAssetsInput
}
...
input AssetUpdateManyWithoutWorksInput {
  create: [AssetCreateWithoutWorksInput!]
  delete: [AssetWhereUniqueInput!]
  connect: [AssetWhereUniqueInput!]
  set: [AssetWhereUniqueInput!]
  disconnect: [AssetWhereUniqueInput!]
  update: [AssetUpdateWithWhereUniqueWithoutWorksInput!]
  upsert: [AssetUpsertWithWhereUniqueWithoutWorksInput!]
  deleteMany: [AssetScalarWhereInput!]
  updateMany: [AssetUpdateManyWithWhereNestedInput!]
}
...
input AssetUpdateWithoutWorksDataInput {
  isCounterfactual: Boolean
  owner: EntityUpdateOneRequiredWithoutOwnedAssetsInput
  issue: IssueUpdateOneRequiredWithoutAssetsInput
  printer: EntityUpdateOneRequiredWithoutPrintedAssetsInput
...
input AssetUpdateWithWhereUniqueWithoutWorksInput {
  where: AssetWhereUniqueInput!
...
input AssetUpsertWithWhereUniqueWithoutWorksInput {
  where: AssetWhereUniqueInput!
...
input WorkCreateInput {
  ...
  x: Int!
  y: Int!
  assets: AssetCreateManyWithoutWorksInput
}

input WorkCreateManyWithoutAssetsInput {
  create: [WorkCreateWithoutAssetsInput!]
  connect: [WorkWhereUniqueInput!]
}

input WorkCreateWithoutAssetsInput {
  id: ID
  x: Int!
  y: Int!
}
...
input WorkUpdateInput {
  x: Int
  y: Int
  assets: AssetUpdateManyWithoutWorksInput
}
...
input WorkUpdateManyWithoutAssetsInput {
  create: [WorkCreateWithoutAssetsInput!]
  delete: [WorkWhereUniqueInput!]
  connect: [WorkWhereUniqueInput!]
  set: [WorkWhereUniqueInput!]
  disconnect: [WorkWhereUniqueInput!]
  update: [WorkUpdateWithWhereUniqueWithoutAssetsInput!]
  upsert: [WorkUpsertWithWhereUniqueWithoutAssetsInput!]
...
input WorkUpdateWithoutAssetsDataInput {
  x: Int
  y: Int
}

input WorkUpdateWithWhereUniqueWithoutAssetsInput {
  where: WorkWhereUniqueInput!
  data: WorkUpdateWithoutAssetsDataInput!
}

input WorkUpsertWithWhereUniqueWithoutAssetsInput {
  where: WorkWhereUniqueInput!
